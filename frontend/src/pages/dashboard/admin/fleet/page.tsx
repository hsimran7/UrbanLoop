  ...
  return (
    <div className="space-y-6 pb-20">
      <div className="glass-card p-8 flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-extrabold text-slate-800 tracking-tight">Live Fleet Command</h1>
          <p className="text-sm text-slate-500 mt-1 font-medium">Real-time GPS tracking and route replay analytics.</p>
        </div>
      </div>
        ...
        <>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="glass-card p-5 text-center">
              <p className="text-[10px] font-bold text-slate-500 uppercase tracking-wider">Total Fleet</p>
              <p className="text-3xl font-extrabold text-slate-800 mt-1">{vehicles.length}</p>
            </div>
            <div className="glass-card p-5 text-center">
              <p className="text-[10px] font-bold text-emerald-600 uppercase tracking-wider">Active Routes</p>
              <p className="text-3xl font-extrabold text-emerald-600 mt-1">{activeCount}</p>
            </div>
            <div className="p-5 rounded-2xl border border-red-200 bg-red-50 text-center">
              <p className="text-[10px] font-bold text-red-600 uppercase tracking-wider">Breakdowns</p>
              <p className="text-3xl font-extrabold text-red-600 mt-1">{breakdownCount}</p>
            </div>
            <div className="glass-card p-5 text-center">
              <p className="text-[10px] font-bold text-slate-500 uppercase tracking-wider">Avg Fleet Speed</p>
          ...
          <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
            <div className="xl:col-span-2 space-y-4">
              <div className="w-full h-[550px] rounded-2xl overflow-hidden border border-surface-border shadow-md">
                <UrbanLoopMap 
              ...
              <div className="glass-card p-5 h-[340px] flex flex-col">
                ...
                <div className="flex-grow overflow-y-auto space-y-3 pr-2">
                  {notifications.length === 0 ? (
                    <p className="text-xs text-slate-400 text-center mt-10">No recent alerts.</p>
                  ) : (
                    notifications.map((n) => (
                      <div key={n.id} className="p-3 bg-nature-lightBg border border-surface-border rounded-xl">
